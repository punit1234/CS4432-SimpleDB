...
public class Buffer {
	 ...
	 * 
	 * Below are also setters and getters.
	 */
	...
	/**
	 * CS4432-Project1:
	 * Pool index used to keep track of which index of the bufferpool array this buffer exists in.
	 * 
	 * *I tried using a hashmap of <Integer , Buffer> in which I circumvent the use of the bufferpool array, but I ran into problems.
	 * I wasnt sure when the rest of SimpleDB set / modified values of the bufferPoolarray, so I kept using the bufferPool array and put a hashmap on top of it.
	 * 
	 * Below are also setters and getters.
	 */
	...
	/***
	 * CS4432-Project1:
	 * shows the buffer's id, the block it is allocated to, and whether the buffer is
	 * pinned.
	 * Assuming buffer ID means which which index of the buffer pool this buffer resides in 
	 */
	@Override
